"""
This script is called by the plugin-wrapper, count_color.js, which passes down the
...
plugin = count_color(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
