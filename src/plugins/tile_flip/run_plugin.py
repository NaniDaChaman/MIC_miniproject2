"""
This script is called by the plugin-wrapper, tile_flip.js, which passes down the
...
from tile_flip import tile_flip
...
plugin = tile_flip(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
