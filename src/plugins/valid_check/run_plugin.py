"""
This script is called by the plugin-wrapper, valid_check.js, which passes down the
...
from valid_check import valid_check
...
plugin = valid_check(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
