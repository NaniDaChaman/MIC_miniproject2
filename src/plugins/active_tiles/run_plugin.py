"""
This script is called by the plugin-wrapper, active_tiles.js, which passes down the
...
from active_tiles import active_tiles
...
plugin = active_tiles(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
